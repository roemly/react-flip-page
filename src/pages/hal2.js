        ...
        >
				...
				<div className="block-news-detail">
					...
					<div className="caption-news">
						...
						<div className="description-news">
							<p>BOGOR – PDAM Tirta Pakuan Kota Bogor telah menyusun rencana relokasi pipa AC 18“ di area longsor</p>
						</div>
					</div>
				</div>
            </article>
            <article>
				<div className="block-news-detail">
					<div className="caption-news">
						<div className="description-news">
							<p>Kampung Bojong Koneng Desa Ciherang Pondok Kecamatan Caringin Kabupaten Bogor. Sebanyak 25 batang pipa HDPE 18” (sebagai pengganti pipa AC) sudah tersedia dan segera diakut menuju area relokasi.</p>
